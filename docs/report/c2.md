...
Dưới đây là sơ đồ quan hệ các thực thể và cấu trúc liên kết (RDM) của hệ thống được căn chỉnh giao diện dạng khối:
...
classDiagram
    ...
    users --> posts : USER_POST
    users --> comments : USER_CMT
    users --> friendships : FRIEND_REQ
    users --> messages : CHAT_SENDER
    
    posts --> comments : POST_CMT
    posts --> hashtags : POST_TAG
    posts --> media_attachments : MSG_MEDIA

    conversations --> messages : CHAT_MSG

    %% Style definition 
    style users fill:#fdf9c4,stroke:#f59e0b,stroke-width:2px,color:#333
    style profiles fill:#fdf9c4,stroke:#f59e0b,stroke-width:2px,color:#333
    style posts fill:#fdf9c4,stroke:#f59e0b,stroke-width:2px,color:#333
    style comments fill:#fdf9c4,stroke:#f59e0b,stroke-width:2px,color:#333
    style friendships fill:#fdf9c4,stroke:#f59e0b,stroke-width:2px,color:#333
    style hashtags fill:#fdf9c4,stroke:#f59e0b,stroke-width:2px,color:#333
    style conversations fill:#fdf9c4,stroke:#f59e0b,stroke-width:2px,color:#333
    style messages fill:#fdf9c4,stroke:#f59e0b,stroke-width:2px,color:#333
    style media_attachments fill:#fdf9c4,stroke:#f59e0b,stroke-width:2px,color:#333
```
