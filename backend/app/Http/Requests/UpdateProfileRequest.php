...
class UpdateProfileRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'cover_position' => ['sometimes', 'integer', 'min:0', 'max:100'],
    ...
    public function messages(): array
    {
        return [
            ...
            'cover_position.integer' => 'Cover position must be an integer',
            'cover_position.min' => 'Cover position must be at least 0',
            'cover_position.max' => 'Cover position must not exceed 100',
